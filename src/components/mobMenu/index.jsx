            ...
            <a href="/" className="MobMenu-item">
                <div className="MobMenu-item_iconBox">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M8.83325 23V15.6667C8.83325 15.0184 9.09079 14.3966 9.54921 13.9382C10.0076 13.4798 10.6294 13.2222 11.2777 13.2222H13.7221C14.3704 13.2222 14.9922 13.4798 15.4506 13.9382C15.909 14.3966 16.1666 15.0184 16.1666 15.6667V23" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
            ...
            <a href="/our_products" className="MobMenu-item">
                <div className="MobMenu-item_iconBox">
                    <svg width="25" height="22" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M23.5686 4.5834L20.9163 15.1947H6.86157L4.20923 4.5834H23.5686Z" stroke="white" stroke-width="0.5" />
                        <path d="M1.11108 1H3.05553L3.88886 4.33333M3.88886 4.33333L6.66664 15.4444H21.1111L23.8889 4.33333H3.88886Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M6.66715 21C7.58763 21 8.33382 20.2538 8.33382 19.3334C8.33382 18.4129 7.58763 17.6667 6.66715 17.6667C5.74668 17.6667 5.00049 18.4129 5.00049 19.3334C5.00049 20.2538 5.74668 21 6.66715 21Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M21.1105 21C22.031 21 22.7772 20.2538 22.7772 19.3334C22.7772 18.4129 22.031 17.6667 21.1105 17.6667C20.19 17.6667 19.4438 18.4129 19.4438 19.3334C19.4438 20.2538 20.19 21 21.1105 21Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
            ...
            <a href="/services" className="MobMenu-item">
                <div className="MobMenu-item_iconBox">
                    <svg width="22" height="26" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.0001 2L1.57153 7.2381M11.0001 2L20.4287 7.2381M11.0001 2L6.28582 4.61905L11.0001 7.2381L15.7144 4.61905L11.0001 2ZM1.57153 7.2381V18.7619M1.57153 7.2381L11.0001 12.4762M1.57153 18.7619L11.0001 24M1.57153 18.7619V13L6.28582 15.619V21.381L1.57153 18.7619ZM11.0001 24L20.4287 18.7619M11.0001 24V12.4762M20.4287 18.7619V7.2381M20.4287 18.7619V13L15.7144 15.619V21.381L20.4287 18.7619ZM20.4287 7.2381L11.0001 12.4762" stroke="white" stroke-width="2" />
                    </svg>
                </div>
