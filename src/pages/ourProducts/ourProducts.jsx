...
export default function OurProducts(params) {
    ...
    return <>
        ...
        <Banner
            ...
            description={"Решает главные задачи АПК: от здоровья растений и <br class='br-desk'> урожайности до благополучия животных и кормовой<br class='br-desk'> безопасности."}
